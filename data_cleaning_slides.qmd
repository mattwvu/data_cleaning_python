...
reviews[['Recommended_IND', 'Division_Name', 'Department_Name', 'Class_Name']].astype("category")
...
reviews = 
reviews.rename(columns={"Recommended_IND": "Recommended_num", "Recommended_recode":"Recommended_label"})
...
## Dplyr function: group_by & aggregate
